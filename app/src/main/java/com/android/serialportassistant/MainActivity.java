package com.android.serialportassistant;
...
import com.android.serialportassistant.AssistBean;
import com.android.serialportassistant.ComBean;
import com.android.serialportassistant.SerialPortFinder;
...
public class MainActivity extends Activity {
	...
	private void setControls()
	{
		...
		try {
			PackageInfo pinfo = getPackageManager().getPackageInfo("com.android.serialportassistant.MainActivity", PackageManager.GET_CONFIGURATIONS);
...
//		}
	...
	private void DispRecData(ComBean ComRecData){
		...
		if (radioButtonTxt.isChecked())
		{
			...
			sMsg.append("[Hex] ");
			sMsg.append(AuxFunc.ByteArrToHex(ComRecData.bRec));
		}
		sMsg.append("\r\n");
